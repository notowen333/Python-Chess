...
class TestChess(unittest.TestCase):
    ...
    def test_castle(self):
        move_list = ['e2-e4', 'e7-e5', 'Ng1-f3', 'Ng8-f6', 'Bf1-c4', 'Bf8-c5', 'O-O', 'O-O', 'Nf3xe5']
        check_list = [
                ['Nb1-a3', 'Nb1-c3', 'Ng1-f3', 'Ng1-h3', 'a2-a4', 'a2-a3', 'b2-b4', 'b2-b3', 'c2-c4', 'c2-c3', 'd2-d4', 'd2-d3', 'e2-e4', 'e2-e3', 'f2-f4', 'f2-f3', 'g2-g4', 'g2-g3', 'h2-h4', 'h2-h3'],
                ['Nb8-a6', 'Nb8-c6', 'Ng8-f6', 'Ng8-h6', 'a7-a5', 'a7-a6', 'b7-b5', 'b7-b6', 'c7-c5', 'c7-c6', 'd7-d5', 'd7-d6', 'e7-e5', 'e7-e6', 'f7-f5', 'f7-f6', 'g7-g5', 'g7-g6', 'h7-h5', 'h7-h6'],
                ['Nb1-a3', 'Nb1-c3', 'Qd1-e2', 'Qd1-f3', 'Qd1-g4', 'Qd1-h5', 'Ke1-e2', 'Bf1-e2', 'Bf1-d3', 'Bf1-c4', 'Bf1-b5', 'Bf1-a6', 'Ng1-f3', 'Ng1-h3', 'Ng1-e2', 'a2-a4', 'a2-a3', 'b2-b4', 'b2-b3', 'c2-c4', 'c2-c3', 'd2-d4', 'd2-d3', 'f2-f4', 'f2-f3', 'g2-g4', 'g2-g3', 'h2-h4', 'h2-h3'],
                ['Nb8-a6', 'Nb8-c6', 'Qd8-e7', 'Qd8-f6', 'Qd8-g5', 'Qd8-h4', 'Ke8-e7', 'Bf8-e7', 'Bf8-d6', 'Bf8-c5', 'Bf8-b4', 'Bf8-a3', 'Ng8-f6', 'Ng8-e7', 'Ng8-h6', 'a7-a5', 'a7-a6', 'b7-b5', 'b7-b6', 'c7-c5', 'c7-c6', 'd7-d5', 'd7-d6', 'f7-f5', 'f7-f6', 'g7-g5', 'g7-g6', 'h7-h5', 'h7-h6'],
                ['Nb1-a3', 'Nb1-c3', 'Qd1-e2', 'Ke1-e2', 'Bf1-e2', 'Bf1-d3', 'Bf1-c4', 'Bf1-b5', 'Bf1-a6', 'Nf3xe5', 'Nf3-h4', 'Nf3-g5', 'Nf3-g1', 'Nf3-d4', 'Rh1-g1', 'a2-a4', 'a2-a3', 'b2-b4', 'b2-b3', 'c2-c4', 'c2-c3', 'd2-d4', 'd2-d3', 'f2-f4', 'g2-g4', 'g2-g3', 'h2-h4', 'h2-h3'],
                ['Nb8-a6', 'Nb8-c6', 'Qd8-e7', 'Ke8-e7', 'Bf8-e7', 'Bf8-d6', 'Bf8-c5', 'Bf8-b4', 'Bf8-a3', 'Nf6xe4', 'Nf6-g8', 'Nf6-d5', 'Nf6-g4', 'Nf6-h5', 'Rh8-g8', 'a7-a5', 'a7-a6', 'b7-b5', 'b7-b6', 'c7-c5', 'c7-c6', 'd7-d5', 'd7-d6', 'f7-f5', 'g7-g5', 'g7-g6', 'h7-h5', 'h7-h6'],
                ['Nb1-a3', 'Nb1-c3', 'Qd1-e2', 'Ke1-f1', 'Ke1-e2', 'Bc4-d5', 'Bc4-e6', 'Bc4xf7', 'Bc4-g8', 'Bc4-b5', 'Bc4-a6', 'Bc4-d3', 'Bc4-e2', 'Bc4-f1', 'Bc4-b3', 'Nf3xe5', 'Nf3-h4', 'Nf3-g5', 'Nf3-g1', 'Nf3-d4', 'Rh1-g1', 'Rh1-f1', 'a2-a4', 'a2-a3', 'b2-b4', 'b2-b3', 'c2-c3', 'd2-d4', 'd2-d3', 'f2-f4', 'g2-g4', 'g2-g3', 'h2-h4', 'h2-h3', 'O-O'],
                ['Nb8-a6', 'Nb8-c6', 'Qd8-e7', 'Ke8-f8', 'Ke8-e7', 'Bc5-d6', 'Bc5-e7', 'Bc5-f8', 'Bc5-b6', 'Bc5-d4', 'Bc5-e3', 'Bc5xf2', 'Bc5xg1', 'Bc5-b4', 'Bc5-a3', 'Nf6xe4', 'Nf6-g8', 'Nf6-d5', 'Nf6-g4', 'Nf6-h5', 'Rh8-g8', 'Rh8-f8', 'a7-a5', 'a7-a6', 'b7-b5', 'b7-b6', 'c7-c6', 'd7-d5', 'd7-d6', 'f7-f5', 'g7-g5', 'g7-g6', 'h7-h5', 'h7-h6', 'O-O'],
                ['Nb1-a3', 'Nb1-c3', 'Qd1-e2', 'Qd1-e1', 'Kg1-h1', 'Bc4-d5', 'Bc4-e6', 'Bc4xf7', 'Bc4xg8', 'Bc4-b5', 'Bc4-a6', 'Bc4-d3', 'Bc4-e2', 'Bc4-b3', 'Nf3xe5', 'Nf3-h4', 'Nf3-e1', 'Nf3-g5', 'Nf3-d4', 'Rf1-e1', 'a2-a4', 'a2-a3', 'b2-b4', 'b2-b3', 'c2-c3', 'd2-d4', 'd2-d3', 'g2-g4', 'g2-g3', 'h2-h4', 'h2-h3'],
                ['Nb8-a6', 'Nb8-c6', 'Qd8-e7', 'Qd8-e8', 'Kg8-h8', 'Bc5-d6', 'Bc5-e7', 'Bc5-b6', 'Bc5-d4', 'Bc5-e3', 'Bc5xf2', 'Bc5xg1', 'Bc5-b4', 'Bc5-a3', 'Nf6-e8', 'Nf6xe4', 'Nf6-d5', 'Nf6-g4', 'Nf6-h5', 'Rf8-e8', 'a7-a5', 'a7-a6', 'b7-b5', 'b7-b6', 'c7-c6', 'd7-d5', 'd7-d6', 'g7-g5', 'g7-g6', 'h7-h5', 'h7-h6'],
        ]
